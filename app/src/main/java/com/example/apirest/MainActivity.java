...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEnviar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                LeerWs();
                enviableWs(txtTitle.getText().toString(), txtBody.getText().toString(), txtUser.getText().toString());
                actualizeWs(txtTitle.getText().toString(), txtBody.getText().toString(), txtUser.getText().toString());
                eliminateWs();
            }
        });
    ...
    private void actualizeWs(final String title, final String body, final String userId) {
